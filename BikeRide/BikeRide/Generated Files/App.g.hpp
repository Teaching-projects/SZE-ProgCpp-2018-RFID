...
void ::BikeRide::App::InitializeComponent()
{
#if defined _DEBUG && !defined DISABLE_XAML_GENERATED_BREAK_ON_UNHANDLED_EXCEPTION
...
::Windows::UI::Xaml::Markup::IXamlType^ ::BikeRide::App::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
    return _AppProvider->GetXamlTypeByType(type);
}

::Windows::UI::Xaml::Markup::IXamlType^ ::BikeRide::App::GetXamlType(::Platform::String^ fullName)
{
    return _AppProvider->GetXamlTypeByName(fullName);
}

::Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::BikeRide::App::GetXmlnsDefinitions()
{
    return ref new ::Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>(0);
}

::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider^ ::BikeRide::App::_AppProvider::get()
{
